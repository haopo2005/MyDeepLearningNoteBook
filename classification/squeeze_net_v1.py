...
def squeeze_net_model_v1(images, is_training, n_classes):
    ...
    '''
    net = conv2d(net, n_classes, [1, 1], strides=(1, 1), name="conv10") #logits不应该经过激活函数
    '''
    ...
    '''
    logits = tf.reduce_mean(net, [1, 2], name='pool10') #也可以用上述average_pooling2d的形式
    return logits
